...
const HomePage = () => {
  return (
    <div id="home">
      ...
      <div
        className="layer1 spacer flex xl:h-[100rem] lg:h-[60rem]"
      >
        {/* About me desc */}
        <div
          className="flex float-left animate-hoverload absolute lg:top-[15rem] lg:left-[5rem] xl:top-[20rem] xl:left-[27rem]"
        >
          <div
            className="bg-gray-800 rounded overflow-hidden lg:w-[32rem] lg:h-[16rem] xl:w-[40rem] xl:h-[23rem] m-auto p-4 shadow-2xl shadow-black hover:scale-[1.05] duration-300"
          >
            {/* type animation  */}
            <TypeAnimation
        ...
        <div
          className="flex float-left xl:top-[15rem] xl:left-[20rem] lg:top-[10rem] lg:left-[2rem] absolute animate-hoverload2"
        >
          <div
            className="bg-gray-800 rounded overflow-hidden xl:w-[20rem] xl:h-[4rem] lg:w-[10rem] lg:h-[4rem] m-auto p-4 border border-gray-900 shadow-lg shadow-black hover:scale-[1.05] duration-300"
          >
            <p className="xl:text-4xl lg:text-2xl text-white p-0 m-0">
              About Me
            </p>
          </div>
        </div>
        ...
        {/* Your Image */}
        <div className="flex float-left xl:top-[12rem] xl:left-[70rem] lg:top-[12rem] lg:left-[40rem] absolute animate-hoverload">
          <div
            className="bg-gray-800 rounded overflow-hidden xl:w-[30rem] xl:h-[34rem] lg:w-[20rem] lg:h-[22.5rem] m-auto p-4O shadow-2xl 
            shadow-black hover:scale-[1.05] duration-300 hover:shadow-blue-500 hover:bg-white"
          >
            <img
              src="/MadeParamartha.png"
              alt="I Gede Made Paramartha Nugraha"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#C62368] xl:h-[60rem] z-0 overflow-hidden lg:h-[80rem]">
        ...
        <div
          className="flex xl:top-[110rem] xl:left-[67rem] lg:top-[110rem] lg:left-[7rem] float-left animate-upNdown2 absolute z-0"
        >
        ...
        <div
          className="flex xl:top-[115rem] xl:left-[13rem] lg:top-[75rem] lg:left-[13rem] float-left animate-upNdown2 absolute z-0"
        >
          <div
            className="text-black bg-white rounded overflow-hidden xl:w-[37rem] xl:h-[30rem] lg:w-[37rem] lg:h-[27rem] m-auto p-4 shadow-lg shadow-black hover:scale-[1.05] duration-300"
          >
            <iframe
              width="560"
              height="315"
        ...
        <div
          className="flex xl:top-[115rem] xl:left-[76rem] lg:top-[115rem] lg:left-[13rem] float-left animate-upNdown absolute z-0"
        >
          <div
            className="text-black bg-white rounded overflow-hidden xl:w-[40rem] xl:h-[30rem] lg:w-[37rem] lg:h-[27rem] m-auto p-4 shadow-lg shadow-black hover:scale-[1.05] duration-300"
          >
            <img
